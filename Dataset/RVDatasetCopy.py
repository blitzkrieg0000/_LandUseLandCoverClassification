...
class SegmentationDatasetBase(Dataset):
    ...
    def ReadMetaData(self, method=DataReadType.IndexMetaFile):
    ...
    def SetWorkerInfo(self, worker_id, num_workers):
        ...
        self.EndIndex = (self.WorkerId + 1) * self.segment_size if self.WorkerId != self.num_workers - 1 else len(self.__len__())
    ...
    def ReadSceneDataByIndexMeta(self, _data: DataSourceMeta):
        ...
        if geoDataset is None:
            geoDataset = self.LoadSegmentationRasterScene(_data)
